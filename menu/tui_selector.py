...
class SelectorFrame(Frame):
    def __init__(self, screen):
        ...
        layout.add_widget(ListBox(height=Widget.FILL_FRAME, add_scroll_bar=True, options = opts1), 0)

        layout.add_widget(Label("Template", align="^"), 1)
        layout.add_widget(ListBox(height=Widget.FILL_FRAME, add_scroll_bar=True, options = opts1), 1)
